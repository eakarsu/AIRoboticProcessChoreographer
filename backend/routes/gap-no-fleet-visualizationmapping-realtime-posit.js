...
const FEATURE_SLUG = 'no-fleet-visualizationmapping-realtime-posit';
const FEATURE_TITLE = 'No fleet visualization/mapping (real-time positions)';
const PROJECT = 'AIRoboticProcessChoreographer';
